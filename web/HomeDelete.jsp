...
%>
 ...
 <section class="home-section" id="favouritemovie_section">
            <div class="tabcontent">
                    ...
                    <h1 style="padding-top: 20px;padding-bottom: 20px;color:white;">Display of Favourite Movies</h1>    
                    <div class="container">
                        <div class="search-container1">


                            <button class="search-button" onclick="submitFormAndScroll()" value="display" type="submit" id="display-button">
                                <p><a href="#favouritemovie_section">Display Favourite Movies</a></p></button> 
...
if (request.getMethod().equals("POST")) {
    ...
    String title = request.getParameter("data-title");
    ...
    if (title != null && !title.isEmpty()) {
        ...
        try {
            ...
            PreparedStatement deletePs = con.prepareStatement("DELETE FROM favourite WHERE title=?");
