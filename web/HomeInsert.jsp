        ...
        <form id="myForm" method="post">
            ...
            <div class="sidebar">
                ...
                <ul class="nav-list">
                    ...
                    <li>
                        <a href="HomeDisplay.jsp#favoritemovie_section" onclick="redirectToFavoriteMoviesSection();">
                            <i class='bx bx-heart' ></i>
                            <span class="links_name" onclick="openCity(event, 'favorite-movies')">
                                <button>Favourite Movies
                                </button>
                            </span>
                        </a>
  ...
  function menuBtnChange() {
   if(sidebar.classList.contains("open")){
     ...
     closeBtn.classList.replace("bx-menu-alt-right","bx-menu");//replacing the iocns class
                ...
                function submitFormAndInsert() {
    document.forms["myForm"].submit();
    
    function redirectToFavoriteMoviesSection() {
    // Redirect to HomeDisplay.jsp
    window.location.href = "HomeDisplay.jsp";

    // Wait for a brief moment (you can adjust the duration as needed)
    setTimeout(function() {
        // Scroll to the "favorite-movies-section" using JavaScript
        var targetSection = document.getElementById("favoritemovie_section");
        if (targetSection) {
            targetSection.scrollIntoView({ behavior: 'smooth' });
        }
    }, 100); // Adjust the timeout value to control the timing of the scroll
}
}
